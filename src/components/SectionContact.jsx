export default function SectionContact() {
  return (
    <section id="contact" className="section section-contact section--alt" aria-labelledby="contact-heading">
      <div className="section__content">
        ...
        <div className="section-contact__grid">
          <a href="mailto:sales@teraverde.com" className="section-contact__card">
            <span className="section-contact__icon" aria-hidden="true">✉</span>
            <span className="section-contact__label">Email</span>
            <span className="section-contact__value">sales@teraverde.com</span>
          </a>
          ...
          <a
            href="https://maps.google.com/?q=15205+Collier+Blvd+Suite+205+Naples+FL+34119"
            target="_blank"
          ...
          >
            ...
            <address className="section-contact__value section-contact__address">
              15205 Collier Blvd Suite 205<br />
              Naples, FL 34119
            </address>
          </a>
        </div>
